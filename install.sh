...
# --- Configuration ---
OWNER="user"  # Replace with actual GitHub owner
REPO="clise"
BINARY_NAME="clise"
...
RELEASE_URL="https://github.com/$OWNER/$REPO/releases/download/$LATEST_RELEASE/${BINARY_NAME}-${TARGET_ARCH}-${TARGET_OS}.tar.gz"
