...
```bash
curl -o- https://raw.githubusercontent.com/0deep/clise/v0.2.0/install.sh | bash
```
```bash
wget -qO- https://raw.githubusercontent.com/0deep/clise/v0.2.0/install.sh | bash
```
...
```bash
curl -o- https://raw.githubusercontent.com/0deep/clise/v0.2.0/install.sh | sudo bash
```
```bash
wget -qO- https://raw.githubusercontent.com/0deep/clise/v0.2.0/install.sh | sudo bash
```
