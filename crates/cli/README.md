...
A terminal-based (TUI) structured data configuration utility powered by JSON Schemas. It allows developers to visually modify and validate config files (JSON, JSONC, YAML, TOML) in their command-line interface.
